...
React Router Specifics:
  - We never need to generate the \`.react-router/+types/*\` files. They are auto generated by react-router.
...
IMPORTANT! - Never suggest creating a file in the .react-router folder. That folder is auto generated by react-router.
